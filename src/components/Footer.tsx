...
const Footer = () => {
  return (
    <footer className="bg-ayodhya-maroon text-white pt-12 pb-6">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Ayodhya Blessings</h3>
            <p className="mb-4">
              Discover the divine experience of Ayodhya, the birthplace of Lord Ram and home to the magnificent Ram Mandir.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-white hover:text-ayodhya-yellow transition-colors">
