    ...
    <div className="page-transition pb-12 pt-16">
      ...
      <div className="container mx-auto px-4">
        ...
        <section className="max-w-4xl mx-auto mb-16 text-center section-animate">
          <h2 className="text-3xl font-bold text-ayodhya-maroon mb-6">The Royal Residence</h2>
        ...
        <section className="mb-16">
          <div className="grid md:grid-cols-2 gap-12 items-center section-animate">
            <div>
              <h2 className="text-2xl font-bold text-ayodhya-maroon mb-4">Palace Design & Architecture</h2>
              <p className="mb-4">
        ...
        <section className="mb-16 bg-ayodhya-cream p-8 rounded-lg section-animate">
          <h2 className="text-2xl font-bold text-ayodhya-maroon mb-6 text-center">Historical Significance</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-bold text-ayodhya-maroon mb-3">Birthplace of Princes</h3>
              <p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-bold text-ayodhya-maroon mb-3">Ramayana Events</h3>
              <p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-bold text-ayodhya-maroon mb-3">Royal Heritage</h3>
              <p>
